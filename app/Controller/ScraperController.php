...
class ScraperController extends Controller
{
	...
	public function pageScraper($urlImdb)
	{
		...
		$urlImdb = trim($urlImdb);

		// si l'url ou l'id passé a une syntaxe valide
		if (preg_match("!^http://www.imdb.com/title/[t]{2}\d{7}/$!", $urlImdb) || preg_match("!^http://www.imdb.com/title/[t]{2}\d{7}/\?.*!", $urlImdb) || preg_match("!^[t]{2}\d{7}$!", $urlImdb)){
